...
//Reference (or lvalue reference), the reference to a lvalue.
int i;
int& r = i;
...
int x = i; // though i is lvalue, but using here, i will be transformed into a rvalue implicitly.
